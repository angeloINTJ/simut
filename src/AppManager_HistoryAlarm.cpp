...
void AppManager::pauseDisplayForFlash(bool lock) {
 /* durante quiet mode cooperativo, Core 1 está congelado
...
void AppManager::processHistoryLogging( ) {
 ...
 /* history só salva com referência de hora válida (NTP
 * sincronizado OU provisional ativo). Threshold 1600000000 = ;
