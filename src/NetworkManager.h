...
public:
 ...
 /* flags adicionais lidas do overlay NetworkTimeData em
 ...
 * StorageManager) para manter NetworkManager desacoplado. */
 ...
 /* set manual de RTC (via settimeofday) para quando NTP
...
private:
 ...
 /* aplica DNS manual (primário e/ou secundário) via lwIP
