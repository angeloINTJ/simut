 ...
 * Sub-header de SystemDefs.h (facade). EXT-003 / F17 .
 *
...
/* trava layout em compile-time. Schema bump deliberado
 ...
 * Expandido de 24→64 em CONFIG_VERSION 13 com migração transparente
 * de v12 via StorageManager::attemptLoad.
 */
 uint8_t reserved[64];
};
/* trava layout do SystemConfig. Adicionar campo sem
