...
enum DemandType {
 ...
 CMD_HTTPS_OFF, /**< system https off confirm — delete web cert/key + reboot (recovers a web locked by a bad TLS pair, from the one channel HTTPS cannot break: serial) */
 ...
 CMD_USER_PIN, /**< v24: strVal1 = username; strVal2 = the PIN, or "off" */
 CMD_USER_POLICY, /**< v25: strVal1 = "<minLen> <keypad> <alphabet>" */
