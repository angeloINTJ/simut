...
public:
 ...
 /** True after begin( ) — prevents accessing SerialBT before initialization. */
 bool isInitialized( ) const { return _initialized; }

 void setValidator(BtAuthValidator validator);

 /** Language for the post-auth banner. Synchronized with CommandManager::setCliLang. */
...
private:
 ...
 uint8_t _language = LANG_EN; /* Default until CommandManager applies preference */
