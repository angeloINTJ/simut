...
enum LogCode {
 ...
 APP_HEAP_REPORT = 511,
 APP_HIST_NO_TIME_REF = 512, /* skip por falta de NTP/provisional */
 APP_HIST_TIME_REF_RECOVERED = 513, /* time ref voltou, retomando saves */
 ...
 WEB_UPLOAD = 574,
 WEB_CLIENT_DISCONNECT = 575, /* cliente fechou conexão durante safeSend — silent broken pipe agora visível */
