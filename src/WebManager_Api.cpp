...
void WebManager::handleApiPerms( ) {
 ...
 /* expõe meta do .lng ativo (code+name) pra Web popular o seletor
...
void WebManager::handleApiNetwork( ) {
 ...
 /* expõe flags do overlay NetworkTimeData para a UI. */
 char json[640];
...
void WebManager::handleApiConfig( ) {
 ...
 /* mascara t_key. Se length>4, expõe só os primeiros 4 chars
 ...
 * a menos que o user digite um valor novo sem o marker. */
 ...
 /* expõe hwId do ambient pra preview de telemetria refletir o ID
