...
const char* MOD_NAMES[] = {"BOOT", "IDLE", "WIFI", "WEB_SERVER", "STORAGE_RD", "STORAGE_WR", "SENSOR", "TELEMETRY", "DISPLAY", "CLI",
 ...
 "TEL_COLLECT", "TEL_BUILD", "TEL_SEND",
 "STO_MAINT", "HIST_SAMPLE", "HIST_WIP", "HIST_SEAL"};
static constexpr uint8_t MOD_NAMES_MAX = 29; /* last valid index */
...
static const char* translateCodeEn(uint16_t code) {
 ...
 case APP_AIR_WAKE_INCOMPLETE: return "Previous Air wake did not complete";
