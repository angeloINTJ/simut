 ...
 */
 ...
 /* 9 itens (Attention adicionado entre Web (4) e Mute (agora 6)). */
 ...
 *enablePtr = false;
 ...
 _forceSettingsRedraw = true;
 _repaintSettings = true;
 /* licença cobriu o keypad com fillScreen — força
 * repintar sem resetar o PIN parcial nem o estado de auth. */
 ...
 /* gate de aceitação manual (sem acceptTouch que disparava
