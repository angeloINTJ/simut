...
- `pip install zopfli` — opcional; sem ele as páginas web caem para `gzip -9` e a imagem fica 2.888 B acima dos números do `tools/flash_budget.json` (ainda dentro da margem)
- Raspberry Pi Pico W
