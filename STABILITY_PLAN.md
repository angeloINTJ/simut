...
| **F-DISPLAY-ATOMIC — eliminar efeito top-down em renders de tela** | 🟡 Em andamento (Fase 0) | `stability-fixes-tier1` | (v3.30.x) | 2026-05-02 |
...
|   · v3.30.11 (revert state diffing): mantém v3.30.9 strips (top-down eliminado), remove v3.30.10 state diffing. Boot deve voltar a funcionar. Flicker reaparece nos 4 fns de calibração — precisa redesign na próxima iteração com abordagem que não interaja com boot. | 🟡 HW pendente | — | `v3.30.11` | 2026-05-02 |
