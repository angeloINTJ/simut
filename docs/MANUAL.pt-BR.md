...
|---|---|---|
| **Sozinho**, quando não há Wi-Fi configurado | todos | é o estado de fábrica |
| **Sozinho**, depois de ~33 min sem conseguir associar | release, alpha | uma rodada inteira da escada de reconexão; o AP se desfaz em 15 min e o aparelho volta a tentar a rede |
...
| O roteador mudou e o aparelho sumiu da rede | Espere ~33 min: ele abre a rede de setup sozinho. Ou force pelo painel, pelo `ap` na USB, ou pelo `ap` por Bluetooth (alpha e Air) |
