...
|---|---|
| `simut_v2.7.1_release.uf2` | Gravar a imagem release pelo USB |
| `simut_v2.7.1_alpha.uf2` | Gravar a imagem alpha pelo USB |
| `simut_v2.7.1_air.uf2` | Gravar a imagem do Air pelo USB |
| `simut_v2.7.1_release.bin` | Atualizar a release pela página **Arquivos** ([capítulo 17](#cap-17-ota)) |
| `simut_v2.7.1_alpha.bin` | Atualizar a alpha pela página **Arquivos** |
| `simut_v2.7.1_air.bin` | Atualizar o Air pela página **Arquivos** |
...
Um aparelho na versão 1.x perde duas coisas no primeiro boot da 2.7.1:
