...
| **B1** | 🟡 **aberto, mas deixou de ser cego**: reproduzido, duas hipóteses descartadas com número, e em 22/09 os dois instrumentos que faltavam foram feitos — PR #150 (o arnês parou de engolir o texto da autópsia; A-contra-A: 0 B contra 550 B) e PR #151 (três fatos da autópsia passam a ser PERSISTIDOS em faixas de `ctx`, +184 B, o que vale no campo, onde não há serial) |
