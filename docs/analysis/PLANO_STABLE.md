...
| **B13** | 🟢 **fechado em 22/09**: o mantenedor resolveu o caminho de rede, e a medição confirma — 270 requisições de corpo grande pelo roteador, **0 cortadas e `cgx` = 0**, contra 3 e +49 no mesmo laço horas antes |
