...
2. ~~**Histórico congelado no tempo sob reboots frequentes**~~ — **diagnosticado e corrigido em 01/08**, lendo os bytes do arquivo em vez da API. O dado nunca esteve perdido: as sete horas "que faltavam" estavam em flash o tempo todo. Dois defeitos compostos, e um terceiro que fica em aberto:
   ...
   **Fica em aberto (defeito C, espaço, não tempo):** `h5FileHasSchema( )` compara o **primeiro** SCHEMA do arquivo com o vigente, não o último. Como o arquivo do dia abriu com 6 canais e o equipamento passou a 11, a comparação nunca casa e **cada append grava um SCHEMA novo** — 36 SCHEMAs para 36 blocos no arquivo da bancada, 54 B cada, contra §14-7. São ~17-25% do orçamento de 7,57 KiB/dia jogados fora. Corrigir exige comparar contra o SCHEMA em vigor (o último do arquivo), não contra o de abertura.
